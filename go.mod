...
require (
	...
	github.com/netwatcherio/netwatcher-control v1.0.4-0.20230107191938-711f5d14693d
...
require (
	...
	github.com/gofiber/storage/mongodb v0.0.0-20220831075939-89493b1be08f // indirect
